...
#define TANG_DEFAULT_CHASE_FORCE 0.2 // 디폴트 추격 가속도
#define TANG_UNIT_SCORE 100 // 점당 추가 가속도 증가
...
#define BULLET_DEFAULT_TIME 50
#define BULLET_UNIT_SCORE 100
#define BULLET_REDUCED_TIME 5
#define BULLET_TIME_MIN 5
